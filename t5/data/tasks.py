...
from t5.data.glue_utils import register_super_glue
...
# ============== SuperGlue, Definite Pronoun Resolution, WSC ===================

register_super_glue(DEFAULT_OUTPUT_FEATURES["inputs"].vocabulary,
                    DEFAULT_OUTPUT_FEATURES["inputs"].add_eos,
                    DEFAULT_OUTPUT_FEATURES["targets"].add_eos)
